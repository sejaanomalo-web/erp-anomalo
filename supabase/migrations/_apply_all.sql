...
-- =====================================================================
-- Migration 018: Financeiro v2 — contas, recorrentes e vínculos
-- (idempotente; estava faltando neste bundle — causa das falhas ao salvar
--  lançamento/conta/recorrente quando o banco foi montado só pelo _apply_all)
-- =====================================================================
...
create policy contas_fin_write on contas_financeiras
  for all
  using (empresa_id = auth_empresa() and auth_papel() in ('admin', 'gestor', 'financeiro'))
  with check (empresa_id = auth_empresa() and auth_papel() in ('admin', 'gestor', 'financeiro'));
